...
#main_win.setFont(QFont("Arial", 12))

#main_win.setStyleSheet(f'background-image: url("fondoapp_tareas.jpg");background-repeat: no-repeat; background-position: center;')

main_win.setObjectName("MainWindow")
main_win.setStyleSheet("""
                       #MainWindow {
                       background-image: url("fondoapp_tareas.jpg");
                       background-repeat: no-repeat;
                        background-position: center;
                       }""")


Mi_fuente = QFontDatabase.addApplicationFont("Minecraftia-Regular.ttf")

if Mi_fuente == -1:
    print("error con la fuente")
else:
    font_families = QFontDatabase.applicationFontFamilies(Mi_fuente)
    print("fuente cargada,", font_families)
...
list_widget.setStyleSheet(f'background-color: {beige} ; color: {azul1}')
list_completadas.setStyleSheet(f'background-color: {beige} ; color: {azul1}')

label1.setStyleSheet(f'background-color: {azul3} ; color: {beige}')
label2.setStyleSheet(f'background-color: {azul3} ; color: {beige}')

texto_num_tareas.setStyleSheet(f'color: {azul1}')

mensaje.setStyleSheet(f'color: {azul1}')
